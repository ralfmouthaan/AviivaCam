...
int Aviiva::GetImage(uint8_t* pImage) {
...
int Aviiva::GetWidth(int64_t &Width) {
...
int Aviiva::GetHeight(int64_t &Height) {
...
int Aviiva::GetGain(double &Gain) {
...
int Aviiva::SetGain(double Gain) {
...
int Aviiva::GetExposure(double &Exposure) {
...
int Aviiva::SetExposure(double Exposure) {
...
int Aviiva::GetExposure2(double* RetVal) {
